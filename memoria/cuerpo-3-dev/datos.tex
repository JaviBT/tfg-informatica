...
\begin{figure}[H]
    \centering
    \subfigure[Número de imágenes de train por región]{
    ...
    \subfigure[Número de imágenes de test por región]{
    ...
    \caption{Número de imágenes de train y test por región en los datos de la CRDDC2022.}
