...
\begin{table}[H]
    ...
    \caption{Tabla de clasificación de resumen de la CRDDC 2022. Se muestran los 10 primeros equipos en el momento de cierre de la competición. Extraído de \cite{Leaderboard_CRDDC2022}. Versión ampliada en anexo \ref{CAP:LEADERBOARD}.}
