...
\subsection{Métricas de evaluación de Ultralytics\label{SEC:METRICAS_ULTRALYTICS}}
...
En la figura \ref{fig:Ultralytics_metrics} se muestran ejemplos de las gráficas que proporciona Ultralytics.
